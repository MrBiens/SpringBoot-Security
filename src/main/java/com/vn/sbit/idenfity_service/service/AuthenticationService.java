...
public class AuthenticationService {
    ...
    * */
    ...
    public SignedJWT verifier (String token, boolean isRefresh) throws ParseException, JOSEException {
        ...
        // lấy thời gian tạo token + thời gian hết hạn , chuyển về mili giây rồi chuyển vào đối tượng ngày mới
                //mục đích là tăng thêm time để Refresh token nếu token hết hạn
